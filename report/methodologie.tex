...
Nous calculons ensuite les trois métriques avec et sans le renommage de fichiers pris en compte comme nous le décrivons dans la \secref{metriques}. A partir de là, nous obtenons deux listes pour chaque métrique, NoD, NoC et CC. Une liste est composée de tous les fichiers du projet plus la valeur de la métrique associée. Nous avons donc une liste sans le renommage pris en compte, l'autre avec. Nous calculons alors la corrélation entre ces deux listes pour chaque métrique.\\ 
